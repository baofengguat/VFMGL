...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default="camelyon17", help='dataset_train used for training')
    ...
    parser.add_argument('--datadir', type=str, required=False, default='./data/camelyon17', help="Data directory")
    parser.add_argument('--reg', type=float, default=0.001, help="L2 regularization strength")
    parser.add_argument('--logdir', type=str, required=False, default='./model_save/dinov2_2024-6-25_llm_fedlwt_resnet18_camelyon17/logs_auc_ratio/',
                        help='Log directory path')
    parser.add_argument('--modeldir', type=str, required=False, default='./model_save/dinov2_2024-6-25_llm_fedlwt_resnet18_camelyon17/models_auc_ratio/',
    ...
    parser.add_argument('--loss_func', type=str, default='crossentropy', help="crossentropy or focalloss")
    ...
    parser.add_argument('--target_model_pre_weights_path', default="./l2t_ww/resnet18-5c106cde.pth", type=str)
    ...
    parser.add_argument('--pairs', type=list, default=[(0, 0), (0, 1), (0, 2), (0, 3), (0, 4), (1, 0), (1, 1), (1, 2), (1, 3), (1, 4), (2, 0), (2, 1), (2, 2), (2, 3), (2, 4), (3, 0), (3, 1), (3, 2), (3, 3), (3, 4)])
...
def train_net_llm_fedlwt(net_id, net,  # target_model
    ...
    if write_log:
        ...
        logger.info('>> Training Val accuracy: {}----->>auc:{}'.format(val_acc, val_auc))
        logger.info('>> Test accuracy: {}----->>auc:{}'.format(test_acc, test_auc))
        logger.info(' ** Training complete **')
    print('>> Training accuracy: %f------->>auc:%f' % (train_acc, train_auc))
    print('>> Training Val accuracy: {}----->>auc:{}'.format(val_acc, val_auc))
